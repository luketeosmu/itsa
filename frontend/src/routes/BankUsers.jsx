            ...
            {role === 'superadmin' ?
                <td className='flex'>
                    ...
                    <label for={'modal-edit-user' + user.id}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="green-600" className="cursor-pointer w-6 h-6 mr-3">
                    ...
                    <label for={"modal-delete-user" + user.id} class="btn">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="red-600" class="cursor-pointer w-6 h-6">
